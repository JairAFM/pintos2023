...
static struct list lista_espera; /*lista de threads que estan en espera de que se cumpla su tiempo de estar durmiendo*/
...
thread_init (void)
{
  ...
  list_init (&lista_espera); /*inicializacion de lista de threads en espera*/
               ...
               thread_func *function, void *aux)
{
  ...
  /*Si el thread nuevo tiene mayor prioridad que el actual, hace que ceda el recurso*/
...
thread_yield (void)
{
  ...
  if (cur != idle_thread)
    ...
    /*Se inserta de forma ordenada por priority*/
    list_insert_ordered (&ready_list, &cur->elem, comparationPriority, NULL);
